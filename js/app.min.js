    ...
    var o = {
        ...
        portfolio: function() {
            ...
            e(".btn-filter a").on("click", function() {
                e(".btn-filter a").removeClass("active"),
        ...
        navbarChange: function() {
            e(n).scroll(function() {
                ...
                if (t > 150) {
                    console.log("Adding not-on-top class");
                    e("nav").removeClass("navbar-transparent");
                    e("body").addClass("not-on-top");
                } else {
                    console.log("Removing not-on-top class");
